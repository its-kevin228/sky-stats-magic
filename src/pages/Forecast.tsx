    ...
    <div className="min-h-screen flex flex-col bg-weather-bg">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 md:py-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-weather-darkBlue mb-2">10-Day Weather Forecast</h1>
          <p className="text-gray-600 text-sm md:text-base">Accurate predictions for {selectedCity}</p>
        </div>
        
        {/* City selection */}
        <div className="mb-8">
          <div className="flex flex-wrap gap-2 justify-center">
            {['Paris', 'London', 'New York', 'Tokyo', 'Sydney'].map((city) => (
              <button
                key={city}
        ...
        <div className="mb-6 flex justify-center">
          <div className="inline-flex bg-white/50 backdrop-blur-sm rounded-full p-1">
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          >
            <h3 className="text-gray-500 text-xs md:text-sm mb-2">Humidity</h3>
          ...
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-glass-sm"
          >
            <h3 className="text-gray-500 text-xs md:text-sm mb-2">Wind Speed</h3>
            <div className="flex items-center">
          ...
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-glass-sm"
          >
            <h3 className="text-gray-500 text-xs md:text-sm mb-2">Max Temperature</h3>
            <div className="flex items-center">
          ...
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-glass-sm"
          >
            <h3 className="text-gray-500 text-xs md:text-sm mb-2">Min Temperature</h3>
            <div className="flex items-center">
              ...
              <table className="min-w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-200 hover:bg-gray-50/50">
                    <td className="py-3 px-4 text-xs md:text-sm text-gray-800">Mon, Jun 5</td>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50/50">
                    <td className="py-3 px-4 text-xs md:text-sm text-gray-800">Tue, Jun 6</td>
                    <td className="py-3 px-4 text-center"><div className="flex justify-center items-center"><Cloud className="text-gray-500" size={18} /></div></td>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50/50">
                    <td className="py-3 px-4 text-xs md:text-sm text-gray-800">Wed, Jun 7</td>
                    <td className="py-3 px-4 text-center"><div className="flex justify-center items-center"><Cloud className="text-gray-500" size={18} /></div></td>
